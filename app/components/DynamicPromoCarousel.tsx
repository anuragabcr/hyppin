...
const promoData: PromoItem[] = [
  {
    id: 1,
    cashbackText: "Get up to 50% cashback*",
    subOffers: ["Free Delivery", "UPI Payments", "Cash On Delivery", "Coupons"],
  ...
  {
    id: 3,
    cashbackText: "Extra 10% Discount",
    subOffers: [
