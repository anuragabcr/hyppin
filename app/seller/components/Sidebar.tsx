...
export default function Sidebar() {
  ...
  // Auto open dropdown if route inside it is active
  useEffect(() => {
  ...
  return (
    <aside className="w-72 h-screen bg-linear-to-b from-[#1e3caa] to-[#2a5298] text-white flex flex-col shadow-xl">
      {/* Logo */}
...
function DropdownItem({
  ...
  return (
    <div>
      ...
      {open && (
        <div className="ml-6 mt-1 space-y-1 transition-all">{children}</div>
      )}
    </div>
  );
}
