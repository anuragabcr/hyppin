...
export const OverviewCard = ({
  ...
  <button
    onClick={onClick}
    className="aspect-square flex flex-col items-center justify-center gap-4 border border-gray-100 rounded-xl bg-white hover:shadow-md transition-shadow group"
  >
